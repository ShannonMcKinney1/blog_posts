---
name: seo-check
description: Check for SEO issues on a website and provide recommendations for improvement.
---
# SEO Conventions
- Use good link text so users and search engines can easily understand what the linked pages contain before they visit.
- Use rel="nofollow" on links that users generate like the comments under each blog post. This will prevent search engines from following those links and potentially indexing low-quality content.
...
# SEO Things to NOT Do
- Do not use the keywords meta tag.
- Do not keyword stuff content. This is excessively repeating the same words over and over.